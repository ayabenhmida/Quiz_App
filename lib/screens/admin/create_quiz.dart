...
class _CreateQuizPageState extends State<CreateQuizPage> with SingleTickerProviderStateMixin {
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Quiz created successfully! Code: $quizCode'),
        ...
        children: [
          ...
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              activeTrackColor: const Color(0xFFFF3355),
              inactiveTrackColor: Colors.white.withOpacity(0.2),
              thumbColor: const Color(0xFFFF3355),
              overlayColor: const Color(0xFFFF3355).withOpacity(0.2),
              valueIndicatorColor: const Color(0xFFFF3355),
